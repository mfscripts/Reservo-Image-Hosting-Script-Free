      ...
      <tr>
	    <td height="1" valign="top" style="background-image:url('<?php echo "http://".$site_url."/"; ?>images/dashed-line.jpg'); background-repeat: repeat-x;"><img src="<?php echo "http://".$site_url."/"; ?>images/dashed-line.jpg" width="4" height="1"></td>
	  </tr>
	  <tr>
	    <td valign="top" bgcolor="#356AA0">
		  &nbsp;<br>&nbsp;
		</td>
	  </tr>
	  <tr>
        <td valign="top"><img src="<?php echo "http://".$site_url."/"; ?>images/sub-bottom.jpg" width="749" height="6"></td>
	  </tr>
</table>
    </td>
  </tr>
